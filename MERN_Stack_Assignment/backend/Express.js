...
// mongo connection
// mongoose.connect("mongodb+srv://user1:<db_password>@cluster0.byknp.mongodb.net/")
// mongoose.connection
//     .once("open", () => { console.log("Connected to DB....."); })
//     .on("error", () => { console.log("problem to connect to DB ..!!!!!"); })

mongoose.connect("mongodb+srv://user1:user1@cluster0.byknp.mongodb.net/test?retryWrites=true&w=majority")
mongoose.connection
    .once("open", () => { console.log("Connected to DB....."); })
    .on("error", (error) => { console.error("problem to connect to DB ..!!!!!", error); });
